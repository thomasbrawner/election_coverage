...
terms = ['chafee','clinton',"o'malley",'sanders','webb',
		 'warren','bush','carson','christie','cruz',
		 'fiorina','gilmore','graham','huckabee','jindal',
		 'kasich','pataki','paul','perry','rubio','santorum',		 
		 'trump','walker','romney','election','presidential',
		 'cycle','primary','primaries','candidate','race']
